...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
    * | LCtl |  Win | LAlt |   `  | LSpc |  Fn1 |  F10 |  F11 |  F12 |   /  | RSpc | RAlt |   ←  |   ↓  |   →  |
    * `--------------------------------------------------------------------------------------------------------'
    */
    [_BASE] = LAYOUT_ortho_5x15(
        ...
        KC_CAPS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_F7,   KC_F8,   KC_F9,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_ENT,
        KC_LCTL, KC_LGUI, KC_LALT, KC_GRV,  KC_SPC,  MO(1),   KC_F10,  KC_F11,  KC_F12,  KC_SLSH, KC_SPC,  KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
